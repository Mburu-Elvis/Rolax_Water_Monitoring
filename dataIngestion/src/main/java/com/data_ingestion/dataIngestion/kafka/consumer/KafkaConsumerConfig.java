...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, SensorDataDTO> consumerFactory() {
        ...
        configProps.put(ConsumerConfig.GROUP_ID_CONFIG, "console-consumer-17454");
        configProps.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
        configProps.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, JsonDeserializer.class);
        configProps.put(JsonDeserializer.VALUE_DEFAULT_TYPE, "com.data_ingestion.dataIngestion.domain.dto.SensorDataDTO");
